                ...
                for(int mpop = pidx ; mpop < pidx+2 ; mpop++)//checkbox: +2?
                {
                    if (Math.random() <= MUTATION_RATE) {
                        ...
                        do {
                            ...
                            //Attention : HC10確保每一科目在排課時能夠符合，同一科目一天至多排一節之原則
                            //計算各科目用的天數
                            int[][][] mCountUsedDay = new int[POPULATION_SIZE + 1][SUBJECT_CNT + 1][DAY_CNT + 1];
                            for (int periodIndex = 0; periodIndex < DAY_CNT * PERIOD_CNT; periodIndex++) {
                                for (int subjectIndex = 1; subjectIndex < (SUBJECT_CNT + 1); subjectIndex++) {
                                    if (temp_classSubjectTable[mpop][periodIndex] == subjectIndex) {
                                        if (periodIndex / 7 == 0) {
                                            mCountUsedDay[mpop][subjectIndex][periodIndex / 7]++;
                                        } else if (periodIndex / 7 == 1) {
                                            mCountUsedDay[mpop][subjectIndex][periodIndex / 7]++;
                                        } else if (periodIndex / 7 == 2) {
                                            mCountUsedDay[mpop][subjectIndex][periodIndex / 7]++;
                                        } else if (periodIndex / 7 == 3) {
                                            mCountUsedDay[mpop][subjectIndex][periodIndex / 7]++;
                                        } else if (periodIndex / 7 == 4) {
                                            mCountUsedDay[mpop][subjectIndex][periodIndex / 7]++;
                                        }
                                    }
                                }
                                    ...
                                    if (children_teacherActualTimetable[mpop][children_classTeacherTable[mpop][selectedMClassId][mp1 / 7][mp1 % 7]][classIndex1 / 7][classIndex1 % 7] == 1 &&
                                        ...
                                        if (mp2 != 0 && mp2 != 9 && mp2 != 10 && mp1 != mp2 && mp2 / 7 != 3 && mp2 / 7 != 6 && m_classSubjectTable[mpop][mp1] != m_classSubjectTable[mpop][mp2]) {
                                            if (children_teacherActualTimetable[mpop][children_classTeacherTable[mpop][selectedMClassId][mp2 / 7][mp2 % 7]][mp1 / 7][mp1 % 7] == 1 &&
                                                ...
                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1]][mp1 / 7]--;
                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1 + 1]][(mp1 + 1) / 7]--;
                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2]][mp2 / 7]--;
                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2 + 1]][(mp2 + 1) / 7]--;

                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1]][mp2 / 7]++;
                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1 + 1]][(mp2 + 1) / 7]++;
                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2]][mp1 / 7]++;
                                                mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2 + 1]][(mp1 + 1) / 7]++;
                                                System.out.println("3.0");

                                                if (mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2]][mp1 / 7] > 1 || mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2 + 1]][(mp1 + 1) / 7] > 1 || mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1]][mp2 / 7] != 2) {
                                                    //checkbox : HC10確保每一科目在排課時能夠符合，同一科目一天至多排一節之原則
                                                    mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1]][mp1 / 7]++;
                                                    mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1 + 1]][(mp1 + 1) / 7]++;
                                                    mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2]][mp2 / 7]++;
                                                    mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2 + 1]][(mp2 + 1) / 7]++;
                                        ...
                                        if (children_teacherActualTimetable[mpop][children_classTeacherTable[mpop][selectedMClassId][mp1 / 7][mp1 % 7]][classIndex1 / 7][classIndex1 % 7] == 1) {
                                            ...
                                            if (mp2 != 0 && mp2 != 9 && mp2 != 10 && mp1 != mp2  && m_classSubjectTable[mpop][mp1] != m_classSubjectTable[mpop][mp2]) {
                                                if (children_teacherActualTimetable[mpop][children_classTeacherTable[mpop][selectedMClassId][mp2 / 7][mp2 % 7]][mp1 / 7][mp1 % 7] == 1) {
                                                    ...
                                                    if (mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2]][mp1 / 7] > 1 || mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1]][mp2 / 7] > 1) {
                                                        //checkbox : HC10確保每一科目在排課時能夠符合，同一科目一天至多排一節之原則
                                                        mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1]][mp1 / 7]++;
                                                        mCountUsedDay[mpop][m_classSubjectTable[mpop][mp2]][mp2 / 7]++;
                                                        mCountUsedDay[mpop][m_classSubjectTable[mpop][mp1]][mp2 / 7]--;
